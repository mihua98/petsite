...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name=u"内容", imagePath="product/main_img/", width=1000, height=300,
                              filePath="product/files/", default='')
    ship_free = models.BooleanField(default=True, verbose_name="是否承担运费")
    # 首页中展示的商品封面图
    goods_front_image = models.ImageField(upload_to="product/main_img/", null=True, blank=True, verbose_name="封面图")
    # 首页中新品展示
